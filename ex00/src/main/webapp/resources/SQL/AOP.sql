...
create table tbl_user(
	...
	--default 0 제약조건은 해당컬럼에 포인터 점수를 저장하지 않아도 기본 값인 0이 저장됨
	);
...
create table tbl_message(
	...
	,targetid varchar2(50) not null --외래키 제약조건으로 설정, tbl_user 테이블의
	-- uid2 컬럼 아이디 값만 저장됨
	,sender varchar2(50) not null --메세지 보낸 사람
	,message varchar(1000) not null --보낸 메시지
...
--주인 테이블 tbl_user의 기본키 컬럼 uid2를 참조하고 있다.
--그러므로 uid2컬럼 아이디값만 저장됨.
